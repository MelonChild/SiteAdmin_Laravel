...
@section('content')
    <blockquote class="layui-elem-quote quoteBox">
		...
		<form class="searchForm layui-form">
			...
			<div class="layui-inline">
				...
				@can('permission-check','article.add')<a class="layui-btn layui-btn-normal add_btn">新增</a>@endcan
            </div>
            @can('permission-check','article.delete')
			<div class="layui-inline">
	...
	<script type="text/html" id="ListBar">
        @can('permission-check','article.edit')<a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>@endcan
		@can('permission-check','article.delete')<a class="layui-btn layui-btn-xs layui-btn-danger" lay-event="del">删除</a>@endcan
		@can('permission-check','article.show')<a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="look">预览</a>@endcan
	</script>
@endsection
...
@section('script')
    <script type="text/javascript">
        ...
        //新增路由
        var addUrl = "{{route('articles.create')}}";
        //编辑路由
        var editUrl = "{{route('articles.index')}}";
        //删除路由
        var delUrl = "{{route('articles.delete')}}";
        //查看路由
        var showUrl = "{{route('articles.index')}}";
    </script>
    <script type="text/javascript">

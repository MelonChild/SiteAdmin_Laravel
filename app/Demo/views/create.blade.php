		...
		<div class="layui-row layui-col-space10">
			<div class="layui-col-md9 layui-col-xs7">
                ...
                <div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input" lay-verify="required" name="keywords" placeholder="关键字">
					</div>
                </div>
                <div class="layui-form-item magt3">
			...
			<div class="layui-col-md3 layui-col-xs5">
				...
				<!-- 图片验证请使用如下格式 -->
				<input type="hidden" name="imgpath" lay-verify="imgpath" value="" id="filepath">
			</div>
		</div>
...
@section('script')
    <script type="text/javascript">
		...
		var addUrl = "{{route('ROUTENAME.store')}}",  //存储路由
